...
/**
 * MongoDB 的 ObjectId 生成策略，每秒最多生成 16777216 = 1 << 24 个不重复的ID。
 * 该算法由于时间和计数部分是独立的，所以在同一个 JVM 中进程内高并发大于 16777216 tps
 * 下生成 ID 会重复，但是该算法具有非常高的性能，且足以应付绝大多数业务逻辑。
 * 
 * @author Jayn Leaew
 */
public class MongoObjectIdGenerator implements IdGenerator {
    ...
    private enum Singleton {
        INSTANCE;
        private final IdGenerator value = new MongoObjectIdGenerator();
    }
     ...
     */
    public static final class ObjectId implements Comparable<ObjectId>, Serializable {
